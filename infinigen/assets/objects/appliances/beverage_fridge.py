...
@gin.configurable
class BeverageFridgeFactory(ParameterizedAssetFactory, AssetFactory):
    parameters_model: ClassVar[type[AssetParameters]] = BeverageFridgeParameters
    ...
    def sample_parameters(dimensions):
        return BeverageFridgeFactory.sample_geometry_parameters()
